...
class UserTypesControllerTest < ActionController::TestCase
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post :create, user_type: { isFacultyUser: @user_type.isFacultyUser, isGenericUSer: @user_type.isGenericUSer, isSuperUser: @user_type.isSuperUser, userID: @user_type.userID }
    end
  ...
  test "should update user_type" do
    put :update, id: @user_type, user_type: { isFacultyUser: @user_type.isFacultyUser, isGenericUSer: @user_type.isGenericUSer, isSuperUser: @user_type.isSuperUser, userID: @user_type.userID }
    assert_redirected_to user_type_path(assigns(:user_type))
  end
