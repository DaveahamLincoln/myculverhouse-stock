...
class NewsItemsControllerTest < ActionController::TestCase
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post :create, news_item: { actionItemID: @news_item.actionItemID, newsDate: @news_item.newsDate, newsText: @news_item.newsText }
    end
  ...
  test "should update news_item" do
    patch :update, id: @news_item, news_item: { actionItemID: @news_item.actionItemID, newsDate: @news_item.newsDate, newsText: @news_item.newsText }
    assert_redirected_to news_item_path(assigns(:news_item))
  end
